...
public class DashboardGenerator {
        ...
        public Path generate(
                        DashboardSummary summary) throws IOException {
        ...
        public Path generate(
                ...
                DashboardPage page = dashboardBuilder.build(
                                summary,
                                configuration);
        ...
        public Path generate(
                        DashboardSummary summary,
                        DashboardGenerationConfiguration generationConfiguration) throws IOException {
