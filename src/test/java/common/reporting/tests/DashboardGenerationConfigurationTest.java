...
public class DashboardGenerationConfigurationTest {
        ...
        public void shouldCreateDefaultGenerationConfiguration() {
                ...
                Assert.assertEquals(
                                configuration.getSummaryPaths().get(2),
                                Paths.get(
                                                "performance",
                                                "reports",
                                                "summary.json"));
        ...
        public void shouldProtectSummaryPathCollection() {
                ...
                List<Path> returned = configuration.getSummaryPaths();
        ...
        @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Summary path must not be null")
        ...
        @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Summary paths must not be null")
        ...
        @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Summary paths must not contain null")
        ...
        @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Dashboard output directory must not be null")
