...
public final class MobileDemoPacer {

    private static final long DEFAULT_DELAY_MILLIS = 1500L;

    private MobileDemoPacer() {
    }
    ...
    public static void pause(String moment) {
        ...
        try {
            ...
            throw new IllegalStateException("Mobile demo pacing was interrupted", exception);
        }
    }
    ...
    private static long delayMillis() {
        try {
            return Math.max(0L, Long.parseLong(
                    System.getProperty("mapaf.demo.pacing.millis", String.valueOf(DEFAULT_DELAY_MILLIS))));
